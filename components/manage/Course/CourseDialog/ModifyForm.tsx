  ...
  return (
    <DialogHeader>
      ...
      <DialogDescription>
        <div className="">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="text-black text-left">
                  ...
                  render={({ field }) => (
                    <FormItem key={Date.now()}>
                      <Select onValueChange={field.onChange} defaultValue={field.value || '空中課程'}>
                        ...
                        <SelectContent className="bg-bgColor border-headingColor rounded-2xl">
              ...
              <div className="flex gap-2">
                ...
                <Button className="mt-2 md:w-20 w-15 ml-auto">
