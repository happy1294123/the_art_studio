...
export default function OneLineDatePicker({ date }: Props) {
  const ref = useRef(null)
  const [windowSize, setWindowSize] = useState<number>(0);
  const [selectedDate, setSelectedDate] = useState(new Date(date))
  const [dateList, setDateList] = useState<MyDate[]>(createDateList())
      ...
      {windowSize > 768
        ...
        : (<>
          ...
          <div className="w-full h-14 relative overflow-hidden">
            ...
            <div className={`flex w-full absolute overflow-x-scroll scroll-smooth gap-8 snap-x pl-[500px] ${styles.myGradient}`} ref={ref}>
